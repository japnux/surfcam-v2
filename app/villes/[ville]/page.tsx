...
// Optimisation: cache la page pendant 1 heure
...
export default async function CityPage({ params }: CityPageProps) {
  ...
  // Optimisation: tri côté serveur pour éviter le spread
  const sortedSpots = spots.sort((a, b) => (b.latitude ?? -90) - (a.latitude ?? -90));
          ...
          <div key={spot.id}>
            <h2 className="text-xl font-bold mb-2 text-center truncate">
              <Link 
                ...
                prefetch={index < 3} // Prefetch seulement les 3 premiers
              >
